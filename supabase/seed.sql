...
insert into public.matters (id, title, client_id, owner_id, matter_type, billing_model, stage, next_action, responsible_party)
values
  ('11111111-1111-1111-1111-111111111111', 'Policy Review – Evergreen', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'Policy Review', 'flat', 'Under Review', 'Draft review pack', 'lawyer'),
  ('22222222-2222-2222-2222-222222222222', 'Contract Review – Lotus Clinic', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'Contract Review', 'hourly', 'Waiting on Client', 'Nudge client', 'client')
